...
test('renders Location', () => {
  ...
  expect(location.innerHTML).toBe(`<div class="location-name">${props.name}</div><div class="location-address lefty">${props.location.address1}</div><div class="location-distance righty">${props.distance.toFixed(2)} meters</div>`);
});
